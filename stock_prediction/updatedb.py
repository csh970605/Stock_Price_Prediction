...
class Get_Stock_From_Naver:
    ...
    def __init__(self):
        ...
        with self.conn.cursor() as curs:
            ...
            sql = """
            CREATE TABLE IF NOT EXISTS opened_date(
                date date,
                primary key (date))
            """
            curs.execute(sql)
